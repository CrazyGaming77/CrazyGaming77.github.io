...
<meta name="description" content="
    ...
    Starting point:
    I had a little knowledge of GitHub and repos as well as config.yml files.
  
  
    Target for this lesson?
    To be able to publish my repo with my blog posts via the GitHub interface.
  
  
    Did I reach my target? 
(add details to "Lesson Review")
    I did reach my target, as my site is now accessible and it contains my blog posts.
